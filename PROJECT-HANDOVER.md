...
| Checkpoint commit | The commit that adds this section is recorded in the line at the very end of this file ("Checkpoint reference"). `git log -1 -- PROJECT-HANDOVER.md` also finds it. |
...
Checkpoint reference: (filled in by the commit that follows this one)
