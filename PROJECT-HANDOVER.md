...
- [ ] Owner decision: 20 WordPress URLs that the migration audit keeps have **no page on this branch**, so they return 404 and are not redirected (destination not decided): `/our-tyre-range/` and 19 blog URLs (`/11-benefits-of-emergency-mobile-tyre-fitting/`, `/asymmetric-and-directional-tyres-difference/`, `/behind-the-scenes-what-tools-do-mobile-tyre-fitters-really-use/`, `/emergency-wheel-nut-removal-what-to-do-if-youve-lost-the-key/`, `/how-to-choose-the-best-tyres-for-my-car-expert-buying-guide/`, `/michelin-radial-tire-history-innovation/`, `/mobile-tyre-fitter-near-me-myths/`, `/mobile-tyre-fitting-livingston-tyre-problems/`, `/pirelli-silent-tyres-uk/`, `/premium-or-budget-which-tyres-keep-you-safer/`, `/tyre-blowout-causes-prevention/`, `/tyre-lifespan-mobile-tyre-repair-guide/`, `/tyre-lifespan/`, `/tyre-services-west-lothian/`, `/tyres-bathgate-technical-breakdown/`, `/what-is-mobile-tyre-fitting/`, `/what-tools-do-mobile-tyre-fitters-use/`, `/which-is-the-best-mobile-tyre-fitting-service-provider-in-the-uk/`, `/why-tyres-fail-mobile-tyre-fitter-falkirk/`). Recreated versions exist on `origin/claude/sfr-motors-audit-4ovs2r`; bring them over or choose redirects.
