...
const SERVICE_CARDS = [
  ...
  { icon: `<path d="M13 2 4 14h6l-1 8 9-12h-6l1-8Z"/>`, title: "Emergency Tyre Assistance", href: "/24-7-mobile-tyre-replacement/", label: "24/7 Mobile Tyre Replacement", text: (t) => `Stuck in ${t} with a flat? We're open 24/7 and often close by.` },
...
const LOCATIONS = [
  ...
  },
  {
    ...
    introText:
      "Harthill sits right on the M8, on the corridor linking Glasgow and Edinburgh, and close to our Bathgate base. Wherever your vehicle is — at home, at work, or stopped at the roadside near the motorway — we bring a fully equipped fitting van to you rather than asking you to find a garage. That covers new tyre fitting, replacements, puncture repair and out-of-hours emergency assistance. Get in touch with your location in Harthill and we'll confirm availability and a price before we set off. See our <a href=\"/your-guide-to-safe-tyre-services-in-harthill/\">guide to safe tyre care for Harthill drivers</a>.",
    areasText:
  ...
  },
  {
    ...
    introText:
      "Linlithgow sits between Bo'ness and Bathgate in West Lothian, on the corridor connecting Falkirk to Edinburgh, and well within reach of our base for a mobile callout. Wherever your vehicle is — at home, at work, or stopped at the roadside — we bring a fully equipped fitting van to you rather than asking you to find a garage. That covers new tyre fitting, replacements, puncture repair and out-of-hours emergency assistance. Get in touch with your location in Linlithgow and we'll confirm availability and a price before we set off. See our guide on <a href=\"/professional-mobile-tyre-services-on-drivers-linlithgow/\">professional mobile tyre services for Linlithgow drivers</a>, or our guide on <a href=\"/tyre-care-and-flat-tyre-help-in-linlithgow/\">tyre care and flat tyre help in Linlithgow</a>.",
    areasText:
